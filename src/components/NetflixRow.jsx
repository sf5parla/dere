              ...
              >
                <div className="netflix-card-image">
                  ...
                  <AnimatePresence>
                    {hoveredItem === item.id && (
                      <motion.div
                        className="netflix-card-overlay"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                      ...
                      >
                        <div className="netflix-card-info">
                          <h4 className="netflix-card-title">{title}</h4>
                          <div className="netflix-card-meta">
                            <span className="netflix-match">{rating.percentage}% Match</span>
                            <span className="netflix-year">{year}</span>
                            <span className="netflix-rating">18+</span>
                          </div>
                        ...
                        <div className="netflix-card-buttons">
                          ...
                          <Link 
                            to={`/${isTV ? 'tv' : 'movie'}/${item.id}`}
                            className="netflix-card-btn netflix-info-btn"
                          >
                            <ChevronDown size={16} />
                          </Link>
                        </div>
